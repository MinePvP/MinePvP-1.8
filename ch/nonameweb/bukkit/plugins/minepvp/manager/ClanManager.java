	...
	public Boolean createClan( String clanName, Player player ) {
		...
		if ( getClanByName(clanName) == null ) {
			...
			if ( getMinPlayerForBuyLand( player ) ) {
				...
				player.sendMessage(ChatColor.RED + "Ihr müsst mindestens " + plugin.getConfig().getInt("Global.Settings.Land.ErsteStufe.MinSpieler") + " Spieler sein um Land zu kaufen!");
			}
